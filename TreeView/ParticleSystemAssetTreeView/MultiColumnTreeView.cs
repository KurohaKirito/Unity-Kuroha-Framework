...
namespace UPRTools.Editor {
    internal class MultiColumnItemTreeView : TreeViewWithTreeModel<CheckItemElement> {
        ...
        public MultiColumnItemTreeView(TreeViewState state, MultiColumnHeader multiColumnHeader, TreeModel<CheckItemElement> model) : base(state, multiColumnHeader, model) {
            // Custom setup
        ...
        protected override void RowGUI(RowGUIArgs args) {
            var item = (TreeViewItem<CheckItemElement>) args.item;
        ...
        void CellGUI(Rect cellRect, TreeViewItem<CheckItemElement> item, MyColumns column, ref RowGUIArgs args) {
    ...
    internal class MultiColumnTreeView : TreeViewWithTreeModel<ParticleSystemElement> {
        ...
        void CellGUI(Rect cellRect, TreeViewItem<ParticleSystemElement> item, MyColumns column, ref RowGUIArgs args) {
            ...
            switch (column) {
                ...
                case MyColumns.MessageChecking: {
                    cellRect.xMin += 3f;
                    DefaultGUI.Label(cellRect, item.data.message, args.selected, args.focused);
                }
                    break;
            }
        }
        ...
        public static MultiColumnHeaderState CreateDefaultMultiColumnHeaderState(float treeViewWidth) {
            var columns = new[] {
                ...
                new MultiColumnHeaderState.Column {
                    headerContent = new GUIContent("MessageChecking"),
                    headerTextAlignment = TextAlignment.Left,
                    sortedAscending = true,
                    sortingArrowAlignment = TextAlignment.Left,
                    width = 60,
