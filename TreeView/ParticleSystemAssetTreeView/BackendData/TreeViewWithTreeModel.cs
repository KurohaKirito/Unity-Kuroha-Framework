...
{
    internal class TreeViewItem<T> : TreeViewItem where T : TreeElement, new()
    {
    ...
    internal class TreeViewWithTreeModel<T> : TreeView where T : TreeElement, new()
    {
