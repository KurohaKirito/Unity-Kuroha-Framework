...
public class MB_MaterialAndUVRect
{
    ...
    /// </summary>
    public MeshBaker2TextureTilingTreatment tilingTreatment = MeshBaker2TextureTilingTreatment.Unknown;
    ...
    public MB_MaterialAndUVRect(Material mat, 
        ...
        MeshBaker2TextureTilingTreatment treatment, 
        string objName)
    {
...
public class MB2_TextureBakeResults : ScriptableObject {
    ...
    public static MB2_TextureBakeResults CreateForMaterialsOnRenderer(GameObject[] gos, List<Material> matsOnTargetRenderer)
    {
        ...
        for (int i = 0; i < rms.Length; i++)
        {
            if (rms[i] != null)
            {
                MB_MaterialAndUVRect matAndUVRect = new MB_MaterialAndUVRect(rms[i], new Rect(0f, 0f, 1f, 1f), true, new Rect(0f,0f,1f,1f), new Rect(0f,0f,1f,1f), new Rect(0,0,0,0), MeshBaker2TextureTilingTreatment.None, "");
    ...
    public class Material2AtlasRectangleMapper
    {
        ...
        public bool TryMapMaterialToUVRect(Material mat, Mesh m, int submeshIdx, int idxInResultMats, MB3_MeshCombinerSingle.MeshChannelsCache meshChannelCache, Dictionary<int, MB_Utility.MeshAnalysisResult[]> meshAnalysisCache,
                                             out MeshBaker2TextureTilingTreatment tilingTreatment, 
                                             ...
                                             MB2_LogLevel logLevel)
        {
            ...
            tilingTreatment = MeshBaker2TextureTilingTreatment.Unknown;
    ...
    public static bool IsMeshAndMaterialRectEnclosedByAtlasRect(MeshBaker2TextureTilingTreatment tilingTreatment, Rect uvR, Rect sourceMaterialTiling, Rect samplingEncapsulatinRect, MB2_LogLevel logLevel)
    {
        ...
        if (tilingTreatment == MeshBaker2TextureTilingTreatment.EdgeToEdgeX)
        {
        ...
        else if (tilingTreatment == MeshBaker2TextureTilingTreatment.EdgeToEdgeY)
        {
        ...
        else if (tilingTreatment == MeshBaker2TextureTilingTreatment.EdgeToEdgeXY)
        {
