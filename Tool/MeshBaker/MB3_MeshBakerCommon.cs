...
/// </summary>		
	...
	public virtual void DestroyMeshEditor(IMeshBaker2EditorMethods editorMethods){
...
/// </summary>	
	...
	protected virtual bool _ValidateForUpdateSkinnedMeshBounds(){
		if (MeshCombiner.outputOption == MeshBaker2OutputOptions.BakeMeshAssetsInPlace){
