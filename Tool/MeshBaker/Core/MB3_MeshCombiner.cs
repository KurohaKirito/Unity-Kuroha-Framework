...
namespace DigitalOpus.MB.Core{
	...
	*/
	...
	public abstract class MB3_MeshCombiner{
		...
		[SerializeField] protected MeshBaker2ValidationLevel _validationLevel = MeshBaker2ValidationLevel.Robust;
		public virtual MeshBaker2ValidationLevel validationLevel{
		...
		[SerializeField] protected MeshBakerRenderType _renderType;
		public virtual MeshBakerRenderType renderType { 
			get{return _renderType;} 
			set{ _renderType = value;} 
		}
		
		[SerializeField] protected MeshBaker2OutputOptions _outputOption;
		public virtual MeshBaker2OutputOptions outputOption { 
			get{return _outputOption;} 
			set{_outputOption = value;} 
		}
	
		[SerializeField] protected MeshBaker2LightmapOptions _lightmapOption = MeshBaker2LightmapOptions.IgnoreUV2;
		public virtual MeshBaker2LightmapOptions lightmapOption { 
        ...
        public virtual bool doUV2(){
			return _lightmapOption == MeshBaker2LightmapOptions.CopyUV2Unchanged || _lightmapOption == MeshBaker2LightmapOptions.PreserveCurrentLightmapping || _lightmapOption == MeshBaker2LightmapOptions.CopyUV2UnchangedToSeparateRects;
		}
		...
		public abstract void DestroyMeshEditor(IMeshBaker2EditorMethods editorMethods);
