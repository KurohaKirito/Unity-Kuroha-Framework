...
namespace DigitalOpus.MB.Core{
	...
	public class MB3_EditorMethods : IMeshBaker2EditorMethods{
...
//		}
		...
		public bool CheckPrefabTypes(MeshBakerObjectsToCombineTypes objectToCombineType, List<GameObject> objsToMesh){
			for (int i = 0; i < objsToMesh.Count; i++){
				...
				if (pt == UnityEditor.PrefabType.None ||
					...
					if (objectToCombineType == MeshBakerObjectsToCombineTypes.PrefabOnly){
				...
				} else if (objectToCombineType == MeshBakerObjectsToCombineTypes.SceneObjOnly){
					//these are prefabs
