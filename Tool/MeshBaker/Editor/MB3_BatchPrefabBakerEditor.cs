...
public class MB3_BatchPrefabBakerEditor : Editor
{
    ...
    public static void BakePrefabs(MB3_BatchPrefabBaker pb, bool doReplaceTargetPrefab)
    {
        ...
        if (mb.MeshCombiner.outputOption != MeshBaker2OutputOptions.BakeMeshAssetsInPlace)
        {
            mb.MeshCombiner.outputOption = MeshBaker2OutputOptions.BakeMeshAssetsInPlace;
        }
