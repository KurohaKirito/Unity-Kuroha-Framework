...
namespace DigitalOpus.MB.Core
{
    ...
    */
    internal class MB3_TextureCombinerPackerMeshBakerHorizontalVertical : MB3_TextureCombinerPackerMeshBaker
    {
        ...
        {
            MeshBaker2PackingAlgorithmEnum GetPackingAlg();
            ...
            MeshBaker2TextureTilingTreatment GetEdge2EdgeTreatment();
        ...
        {
            public MeshBaker2PackingAlgorithmEnum GetPackingAlg()
            {
                return MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerVertical;
            }
            ...
            public MeshBaker2TextureTilingTreatment GetEdge2EdgeTreatment()
            {
                return MeshBaker2TextureTilingTreatment.EdgeToEdgeY;
            }
        ...
        private class HorizontalPipeline : IPipeline
        {
            public MeshBaker2PackingAlgorithmEnum GetPackingAlg()
            {
                return MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerHorizontal;
            }
            ...
            public MeshBaker2TextureTilingTreatment GetEdge2EdgeTreatment()
            {
                return MeshBaker2TextureTilingTreatment.EdgeToEdgeX;
            }
        ...
        public override AtlasPackingResult[] CalculateAtlasRectangles(MB3_TextureCombinerPipeline.TexturePipelineData data, bool doMultiAtlas, MB2_LogLevel LOG_LEVEL)
        {
            ...
            Debug.Assert(data._packingAlgorithm != MeshBaker2PackingAlgorithmEnum.UnityPackTextures, "Unity texture packer cannot be used");
            ...
            MeshBaker2PackingAlgorithmEnum packingAlgorithm;
            ...
            {
                packingAlgorithm = MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePacker;
                ...
                tp = MB3_TextureCombinerPipeline.CreateTexturePacker(MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePacker);
                tp.atlasMustBePowerOfTwo = false;
