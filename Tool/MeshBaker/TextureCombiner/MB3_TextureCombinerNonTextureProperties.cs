...
namespace DigitalOpus.MB.Core
{
    public class MB3_TextureCombinerNonTextureProperties
    {
        ...
        private interface NonTextureProperties
        {
            ...
            void AdjustNonTextureProperties(Material resultMat, List<ShaderTextureProperty> texPropertyNames, List<MB_TexSet> distinctMaterialTextures, IMeshBaker2EditorMethods editorMethods);
        ...
        private class NonTexturePropertiesDontBlendProps : NonTextureProperties
        {
            ...
            public void AdjustNonTextureProperties(Material resultMat, List<ShaderTextureProperty> texPropertyNames, List<MB_TexSet> distinctMaterialTextures, IMeshBaker2EditorMethods editorMethods)
            {
                Debug.Assert(_textureProperties._considerNonTextureProperties == false);
        ...
        //by that color
        internal void AdjustNonTextureProperties(Material resultMat, List<ShaderTextureProperty> texPropertyNames, List<MB_TexSet> distinctMaterialTextures, IMeshBaker2EditorMethods editorMethods)
        {
            if (resultMat == null || texPropertyNames == null) return;
