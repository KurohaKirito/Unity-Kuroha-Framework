...
public class MB3_TextureBaker : MB3_MeshBakerRoot
{
    ...
    [SerializeField]
    protected MeshBaker2PackingAlgorithmEnum _packingAlgorithm = MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePacker;
    public virtual MeshBaker2PackingAlgorithmEnum packingAlgorithm
    {
    ...
    */
    ...
    public IEnumerator CreateAtlasesCoroutine(ProgressUpdateDelegate progressInfo, CreateAtlasesCoroutineResult coroutineResult, bool saveAtlasesAsAssets = false, IMeshBaker2EditorMethods editorMethods = null, float maxTimePerFrame = .01f)
    {
        ...
        if (!DoCombinedValidate(this, MeshBakerObjectsToCombineTypes.DontCare, null, vl))
        {
            coroutineResult.isFinished = true;
            yield break;
        }
    ...
    /// </param>
    public MB_AtlasesAndRects[] CreateAtlases(ProgressUpdateDelegate progressInfo, bool saveAtlasesAsAssets = false, IMeshBaker2EditorMethods editorMethods = null)
    {
