...
namespace DigitalOpus.MB.Core
{
    ...
    public class MB3_TextureCombiner
    {
        ...
        [SerializeField]
        protected MeshBaker2PackingAlgorithmEnum _packingAlgorithm = MeshBaker2PackingAlgorithmEnum.UnityPackTextures;
        public MeshBaker2PackingAlgorithmEnum packingAlgorithm
        {
	    ...
	    *  <remarks>Combines meshes and generates texture atlases</remarks> */
        ...
        public IEnumerator CombineTexturesIntoAtlasesCoroutine(ProgressUpdateDelegate progressInfo, MB_AtlasesAndRects resultAtlasesAndRects, Material resultMaterial, List<GameObject> objsToMesh, List<Material> allowedMaterialsFilter, IMeshBaker2EditorMethods textureEditorMethods = null, CombineTexturesIntoAtlasesCoroutineResult coroutineResult = null, float maxTimePerFrame = .01f, List<AtlasPackingResult> packingResults = null, bool onlyPackRects = false)
        {
        ...
        IEnumerator _CombineTexturesIntoAtlases(ProgressUpdateDelegate progressInfo, CombineTexturesIntoAtlasesCoroutineResult result, MB_AtlasesAndRects resultAtlasesAndRects, Material resultMaterial, List<GameObject> objsToMesh, List<Material> allowedMaterialsFilter, IMeshBaker2EditorMethods textureEditorMethods, List<AtlasPackingResult> atlasPackingResult, bool onlyPackRects)
        {
            ...
            try
            {
                ...
                if (_fixOutOfBoundsUVs && (_packingAlgorithm == MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerHorizontal ||
                                            _packingAlgorithm == MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerVertical))
                {
            ...
            List<MB_TexSet> distinctMaterialTextures)
        {
            ...
            if (_packingAlgorithm == MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerVertical && _useMaxAtlasHeightOverride)
            {
            ...
            if (_packingAlgorithm == MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerHorizontal && _useMaxAtlasWidthOverride)
            {
        ...
        IEnumerator __CombineTexturesIntoAtlases(ProgressUpdateDelegate progressInfo, CombineTexturesIntoAtlasesCoroutineResult result, MB_AtlasesAndRects resultAtlasesAndRects, MB3_TextureCombinerPipeline.TexturePipelineData data, IMeshBaker2EditorMethods textureEditorMethods)
        {
        ...
        IEnumerator __RunTexturePacker(CombineTexturesIntoAtlasesCoroutineResult result, MB3_TextureCombinerPipeline.TexturePipelineData data, IMeshBaker2EditorMethods textureEditorMethods, List<AtlasPackingResult> packingResult)
        {
