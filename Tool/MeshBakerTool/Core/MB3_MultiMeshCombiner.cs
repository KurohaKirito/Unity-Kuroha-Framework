...
namespace DigitalOpus.MB.Core
{
    ...
    public class MB3_MultiMeshCombiner : MB3_MeshCombiner
    {
        ...
        public override MeshBaker2ValidationLevel validationLevel
        {
            set
            {
        ...
        {
            if (_validationLevel == MeshBaker2ValidationLevel.None) return true;
            ...
            if (gos != null)
            {
                for (int i = 0; i < gos.Length; i++)
                {
                    ...
                    if (_validationLevel >= MeshBaker2ValidationLevel.Robust)
                    {
        ...
        void _setMBValues(MB3_MeshCombinerSingle targ)
        {
            ...
            targ.outputOption = MeshBaker2OutputOptions.BakeIntoSceneObject;
