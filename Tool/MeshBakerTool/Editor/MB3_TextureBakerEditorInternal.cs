...
namespace DigitalOpus.MB.Core
{
    public class MB3_TextureBakerEditorInternal
    {
        ...
        public static void CreateNewTextureBaker()
        {
            ...
            tb.packingAlgorithm = MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePacker;
        }
        ...
        public void DrawGUI(SerializedObject textureBaker, MB3_TextureBaker momm, System.Type editorWindow)
        {
            ...
            if (texturePackingAlgorithm.intValue == (int)MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePacker ||
                texturePackingAlgorithm.intValue == (int)MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerFast)
            {
            ...
            if (texturePackingAlgorithm.intValue == (int)MeshBaker2PackingAlgorithmEnum.UnityPackTextures)
            {
            ...
            {
                if (texturePackingAlgorithm.enumValueIndex == (int)MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerHorizontal)
                {
                ...
                else if (texturePackingAlgorithm.enumValueIndex == (int)MeshBaker2PackingAlgorithmEnum.MeshBakerTexturePackerVertical)
                {
        ...
        public static void ConfigureMutiMaterialsFromObjsToCombine(MB3_TextureBaker mom, SerializedProperty resultMaterials, SerializedObject textureBaker)
        {
            ...
            {
                if (mom.packingAlgorithm == MeshBaker2PackingAlgorithmEnum.UnityPackTextures)
                {
