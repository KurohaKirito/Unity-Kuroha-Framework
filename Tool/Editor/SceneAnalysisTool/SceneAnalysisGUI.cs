...
namespace Script.Effect.Editor.AssetTool.Tool.Editor.SceneAnalysisTool
{
    public class SceneAnalysisGUI : UnityEditor.Editor
    {
        ...
        {
            SceneAnalysisTableWindow.Open(MeshAnalysisData.DetectType.Scene,
                MeshAnalysisData.DetectTypeAtPath.Meshes,
                MeshAnalysisData.DetectMeshType.ColliderMesh, null, null);
        }
        ...
        private static void CheckAllRenderer()
        {
            SceneAnalysisTableWindow.Open(MeshAnalysisData.DetectType.Scene,
                MeshAnalysisData.DetectTypeAtPath.Meshes,
                MeshAnalysisData.DetectMeshType.RendererMesh, null, null);
        }
