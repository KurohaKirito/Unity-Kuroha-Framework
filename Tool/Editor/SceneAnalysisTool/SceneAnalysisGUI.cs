...
namespace Script.Effect.Editor.AssetTool.Tool.Editor.SceneAnalysisTool {
    public class SceneAnalysisGUI : UnityEditor.Editor {
        ...
        public static void OnGUI() {
            ...
            if (foldout) {
                ...
                GUILayout.BeginVertical("Box");
                {
                    ...
                    GUILayout.BeginVertical("Box");
                    if (GUILayout.Button("统计碰撞 Mesh", GUILayout.Height(UI_BUTTON_HEIGHT), GUILayout.Width(UI_BUTTON_WIDTH))) {
                        CheckAllCollider();
                    }
                    ...
                    GUILayout.BeginVertical("Box");
                    if (GUILayout.Button("统计渲染 Mesh", GUILayout.Height(UI_BUTTON_HEIGHT), GUILayout.Width(UI_BUTTON_WIDTH))) {
                        CheckAllRenderer();
                    }
                    ...
                    GUILayout.BeginVertical("Box");
                    if (GUILayout.Button(isAdvanceMode? "关闭高级模式" : "开启高级模式", GUILayout.Height(UI_BUTTON_HEIGHT), GUILayout.Width(UI_BUTTON_WIDTH))) {
        ...
        private static void CheckAllCollider() {
            SceneAnalysisTableWindow.Open(MeshAnalysisData.DetectType.Scene, MeshAnalysisData.DetectTypeAtPath.Meshes, MeshAnalysisData.DetectMeshType.ColliderMesh, null, null);
        }
        ...
        private static void CheckAllRenderer() {
            SceneAnalysisTableWindow.Open(MeshAnalysisData.DetectType.Scene, MeshAnalysisData.DetectTypeAtPath.Meshes, MeshAnalysisData.DetectMeshType.RendererMesh, null, null);
        }
