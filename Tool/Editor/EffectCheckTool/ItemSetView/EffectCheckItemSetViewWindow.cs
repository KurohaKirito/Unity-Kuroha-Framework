...
namespace Script.Effect.Editor.AssetTool.Tool.Editor.EffectCheckTool.ItemSetView {
    /// <summary>
    /// 单个检查项设置页面
    /// </summary>
    public class EffectCheckItemSetViewWindow : EditorWindow {
        ...
        private void OnGUI() {
            ...
            itemInfo.dangerLevel = EditorGUILayout.Popup("危险级别", itemInfo.dangerLevel, EffectCheckItemSetView.dangerLevelOptions);
