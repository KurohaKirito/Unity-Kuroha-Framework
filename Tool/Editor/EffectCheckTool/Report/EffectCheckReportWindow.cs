...
namespace Script.Effect.Editor.AssetTool.Tool.Editor.EffectCheckTool.Report {
    public class EffectCheckReportWindow : EditorWindow {
        ...
        public static void Open(List<EffectCheckReportInfo> results) {
            ...
            window.minSize = new Vector2(1200, 690);
        }
        ...
        private void OnGUI() {
            ...
            {
                if (indexBegin >= 0 && indexBegin < EffectCheckReport.reportInfos.Count && indexEnd >= 0 && indexEnd < EffectCheckReport.reportInfos.Count && indexBegin <= indexEnd) {
