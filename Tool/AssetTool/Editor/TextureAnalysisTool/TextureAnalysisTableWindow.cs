        ...
        private CommonTableColumn<TextureAnalysisData>[] InitColumns()
        {
            return new[]
            {
                ...
                new CommonTableColumn<TextureAnalysisData>
                {
                    ...
                    allowToggleVisibility = true,
                    canSort = true,
                    Compare = (dataA, dataB, sortType) => Kuroha.Util.RunTime.StringUtil.CompareByBoolAndString(
                ...
                new CommonTableColumn<TextureAnalysisData>
                {
                    ...
                    autoResize = false,
                    canSort = true,
                    Compare = (dataA, dataB, sortType) => Kuroha.Util.RunTime.StringUtil.CompareByNumber(dataA.repeatInfo, dataB.repeatInfo, sortType),
                    DrawCell = (cellRect, data) =>
                    {
                        cellRect.height += 5f;
                        cellRect.xMin += 3f;
